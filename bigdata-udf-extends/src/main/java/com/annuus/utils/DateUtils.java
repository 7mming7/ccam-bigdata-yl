...
public class DateUtils {
     ...
     * 本方法不指定format，采用默认的format，DateUtils.DATE_FORMAT_DAFAULT；如果需要制定format，
    ...
    public static List<Calendar> dayListSinceCal(Calendar startCal, Calendar endCal) {
        ...
        try {
            while (startCal.getTime().before(endCal.getTime()) || startCal.getTime().equals(endCal.getTime())) {
                calendarList.add(DateUtils.stringToCalendar(formatDate(startCal.getTime(), DATE_FORMAT_DAFAULT), DateUtils.DATE_FORMAT_DAFAULT));
    ...
    public static Calendar getQuarterFirstCal(Calendar calendar) {
        ...
        try {
            ...
            SimpleDateFormat sdf = new SimpleDateFormat(DateUtils.DATE_FORMAT_Y_M_D);
    ...
    public static Calendar getQuarterEndCal(Calendar calendar) {
        ...
        try {
            ...
            SimpleDateFormat sdf = new SimpleDateFormat(DateUtils.DATE_FORMAT_Y_M_D);
            Date endDate = sdf.parse(stringToSdf(DateUtils.DATE_FORMAT_Y_M_D).format(cal.getTime()) + " 23:59:59");
    ...
    public static int[] getYearFirstAndLastInt(Calendar calendar) {
        ...
        dayArray[0] = Integer.parseInt(formatCalendar(calendarArray[0], DateUtils.DATE_FORMAT_DAFAULT));
        dayArray[1] = Integer.parseInt(formatCalendar(calendarArray[1], DateUtils.DATE_FORMAT_DAFAULT));
        return dayArray;
    }
    ...
    public static int[] getYearFirstAndInputInt(Calendar calendar) {
        ...
        int[] dayArray = new int[2];
        dayArray[0] = Integer.parseInt(formatCalendar(calendarArray[0], DateUtils.DATE_FORMAT_DAFAULT));
        dayArray[1] = Integer.parseInt(formatCalendar(calendar, DateUtils.DATE_FORMAT_DAFAULT));
        return dayArray;
    }
    ...
    public static void main(String[] args) {
        ...
        *//*cal.set(Calendar.DAY_OF_MONTH, 18);instanceTime
        ...
        System.out.println(DateUtils.dateMigrate("Day", -1, "20151022000000"));
        *//*for (Calendar calendar:calendarList) {
        ...
        for (Calendar calendar:calendars) {
            System.out.println(DateUtils.formatCalendar(calendar,DATE_FORMAT_DAFAULTYMDHMS));
        }*/
        /*int cal = 2015112015;
        Calendar calendar = intDate2CalendarHour(cal);
        try {
            Calendar calendar1 = stringToCalendar("2015112015", DateUtils.DATE_FORMAT_YMDH);
            System.out.println(DateUtils.formatCalendar(calendar1,DATE_FORMAT_DAFAULTYMDHMS));
        } catch (ParseException e) {
            e.printStackTrace();
        }*/

        System.out.println(DateUtils.dateMigrate("day", -1, "20160101000000"));
    }
}