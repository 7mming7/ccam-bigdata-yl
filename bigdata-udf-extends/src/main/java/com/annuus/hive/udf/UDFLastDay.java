...
@HivePdkUnitTests(
		...
		cases = {
			@HivePdkUnitTest(
				query = "SELECT nexr_last_day('2003-03-15 01:22:33') FROM dual;",
				result = "2003-03-31 00:00:00"
			),
			@HivePdkUnitTest(
				query = "SELECT nexr_last_day('2011-07-21 09:21:00') FROM dual;",
				result = "2011-07-31 00:00:00"
			)
		}
	)
public class UDFLastDay extends UDF {
	private SimpleDateFormat standardFormatter = new SimpleDateFormat("yyyyMMdd");
	...
	public Text evaluate(Text dateText, Text patternText) {
		System.out.println("evaluate(Text dateText, Text patternText)");
		if (dateText == null) {
			return null;
    ...
    /*public static void main(String[] args){
		UDFLastDay udfFirstDay = new UDFLastDay();
