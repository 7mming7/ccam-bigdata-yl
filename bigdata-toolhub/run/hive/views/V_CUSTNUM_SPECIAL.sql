use zhgltest;
CREATE VIEW if not exists V_CUSTNUM_SPECIAL AS
SELECT ACCT.CUSTR_NBR AS CUSTR_NBR,
     ...
     FROM FDM_S24_CUR_CUSTR acct
          ...
          (  SELECT A.CUSTR_NBR,
               ...
               FROM V_FDM_S24_CUR_ACCT_COM a, MDM_STMT_X spay
          ...
          (  SELECT A.CUSTR_NBR,
               ...
               FROM V_FDM_S24_CUR_ACCT_COM a inner join MDM_STMT_X spay on A.XACCOUNT = SPAY.XACCOUNT
                    left join 
              ...
              WHERE     todate(spay.STMT_DATE,'yyyy-mm-dd') >= ADD_MONTHS (SYSDATE(), -6)
                    AND todate(spay.STMT_DATE,'yyyy-mm-dd') < SYSDATE()
          ...
          (  SELECT ACCT.CUSTR_NBR CUSTR_NBR,
               ...
               FROM V_FDM_S24_CUR_ACCT_COM acct
                    INNER JOIN
