...
CREATE VIEW if not exists V_MAIN_BASIC_SP AS
SELECT CUSTNUM,
            ...
            MAX (STMTFEEINCREASEMONTH_L6M + 0) STMTFEEINCREASEMONTH_L6M,
            SUM (STMTSUMCASH_L6M) STMTSUMCASH_L6M,               
            MIN (STMTCASHADVANCEMONTH_L6M + 0) STMTCASHADVANCEMONTH_L6M,
            SUM (STMTSUMCONSUME_L6M) STMTSUMCONSUME_L6M,         
            MAX (PAST6_DUE_COUNT_MAX + 0) PAST6_DUE_COUNT_MAX,
            MAX (ARREARINCREASE_L12M + 0) ARREARINCREASE_L12M,SUM (LAST_12MON_CONSUME_AMT_1) LAST_12MON_CONSUME_AMT_1,SUM (LAST_12MON_CONSUME_AMT_2) LAST_12MON_CONSUME_AMT_2, SUM (LAST_12MON_CONSUME_AMT_3) LAST_12MON_CONSUME_AMT_3,SUM (LAST_12MON_CONSUME_AMT_4) LAST_12MON_CONSUME_AMT_4,SUM (LAST_12MON_CONSUME_AMT_5) LAST_12MON_CONSUME_AMT_5, SUM (LAST_12MON_CONSUME_AMT_6) LAST_12MON_CONSUME_AMT_6,SUM (LAST_12MON_CONSUME_AMT_7) LAST_12MON_CONSUME_AMT_7,SUM (LAST_12MON_CONSUME_AMT_8) LAST_12MON_CONSUME_AMT_8,
            SUM (LAST_12MON_CONSUME_AMT_9) LAST_12MON_CONSUME_AMT_9,   
            ...
            SUM (PBOC_ACCTNUMB_UTILIZATION50UP) PBOC_ACCTNUMB_UTILIZATION50UP 
                                                                             ,SUM (LAST_24MON_OVD_TERM_1) LAST_24MON_OVD_TERM_1,SUM (LAST_24MON_OVD_TERM_2) LAST_24MON_OVD_TERM_2,SUM (LAST_24MON_OVD_TERM_3) LAST_24MON_OVD_TERM_3,SUM (LAST_24MON_OVD_TERM_4) LAST_24MON_OVD_TERM_4,SUM (LAST_24MON_OVD_TERM_5) LAST_24MON_OVD_TERM_5,SUM (LAST_24MON_OVD_TERM_6) LAST_24MON_OVD_TERM_6,SUM (LAST_24MON_OVD_TERM_7) LAST_24MON_OVD_TERM_7,SUM (LAST_24MON_OVD_TERM_8) LAST_24MON_OVD_TERM_8,SUM (LAST_24MON_OVD_TERM_9) LAST_24MON_OVD_TERM_9,SUM (LAST_24MON_OVD_TERM_10) LAST_24MON_OVD_TERM_10,SUM (LAST_24MON_OVD_TERM_11) LAST_24MON_OVD_TERM_11,SUM (LAST_24MON_OVD_TERM_12) LAST_24MON_OVD_TERM_12,MAX (LAST_24MON_OVD_TERM_13) LAST_24MON_OVD_TERM_13,
