...
v_sql32 := v_sql32||'    CASE WHEN  (coal(T4.LAST_24MON_OVD_FLAG_1,''0'') + 0) > ''0'' OR  (coal(T14.LAST_24MON_OVD_FLAG_1,''0'') + 0) > ''0'' ';
v_sql32 := v_sql32||'         THEN ''1'' ';
v_sql32 := v_sql32||'         ELSE ''0'' ';
v_sql32 := v_sql32||'    END , ';
v_sql32 := v_sql32||'    CASE WHEN  (coal(T4.LAST_24MON_OVD_FLAG_2,''0'') + 0) > ''0'' OR  (coal(T14.LAST_24MON_OVD_FLAG_2,''0'') + 0) > ''0'' ';
v_sql32 := v_sql32||'         THEN ''1'' ';
v_sql32 := v_sql32||'         ELSE ''0'' ';
v_sql32 := v_sql32||'    END , ';
v_sql32 := v_sql32||'    CASE WHEN  (coal(T4.LAST_24MON_OVD_FLAG_3,''0'') + 0) > ''0'' OR  (coal(T14.LAST_24MON_OVD_FLAG_3,''0'') + 0) > ''0'' ';
v_sql32 := v_sql32||'         THEN ''1'' ';
v_sql32 := v_sql32||'         ELSE ''0'' ';
v_sql32 := v_sql32||'    END , ';
v_sql32 := v_sql32||'    CASE WHEN  (coal(T4.LAST_24MON_OVD_FLAG_4,''0'') + 0) > ''0'' OR  (coal(T14.LAST_24MON_OVD_FLAG_4,''0'') + 0) > ''0'' ';
v_sql32 := v_sql32||'         THEN ''1'' ';
v_sql32 := v_sql32||'         ELSE ''0'' ';
v_sql32 := v_sql32||'    END , ';
v_sql32 := v_sql32||'    CASE WHEN  (coal(T4.LAST_24MON_OVD_FLAG_5,''0'') + 0) > ''0'' OR  (coal(T14.LAST_24MON_OVD_FLAG_5,''0'') + 0) > ''0'' ';
v_sql32 := v_sql32||'         THEN ''1'' ';
v_sql32 := v_sql32||'         ELSE ''0'' ';
v_sql32 := v_sql32||'    END , ';
v_sql32 := v_sql32||'    CASE WHEN  (coal(T4.LAST_24MON_OVD_FLAG_6,''0'') + 0) > ''0'' OR  (coal(T14.LAST_24MON_OVD_FLAG_6,''0'') + 0) > ''0'' ';
v_sql32 := v_sql32||'         THEN ''1'' ';
v_sql32 := v_sql32||'         ELSE ''0'' ';
v_sql32 := v_sql32||'    END , ';
v_sql32 := v_sql32||'    CASE WHEN  (coal(T4.LAST_24MON_OVD_FLAG_7,''0'') + 0) > ''0'' OR  (coal(T14.LAST_24MON_OVD_FLAG_7,''0'') + 0) > ''0'' ';
v_sql32 := v_sql32||'         THEN ''1'' ';
v_sql32 := v_sql32||'         ELSE ''0'' ';
v_sql32 := v_sql32||'    END , ';
v_sql32 := v_sql32||'    CASE WHEN  (coal(T4.LAST_24MON_OVD_FLAG_8,''0'') + 0) > ''0'' OR  (coal(T14.LAST_24MON_OVD_FLAG_8,''0'') + 0) > ''0'' ';
v_sql32 := v_sql32||'         THEN ''1'' ';
v_sql32 := v_sql32||'         ELSE ''0'' ';
v_sql32 := v_sql32||'    END , ';
v_sql32 := v_sql32||'    CASE WHEN  (coal(T4.LAST_24MON_OVD_FLAG_9,''0'') + 0) > ''0'' OR  (coal(T14.LAST_24MON_OVD_FLAG_9,''0'') + 0) > ''0'' ';
v_sql32 := v_sql32||'         THEN ''1'' ';
v_sql32 := v_sql32||'         ELSE ''0'' ';
v_sql32 := v_sql32||'    END , ';
v_sql32 := v_sql32||'    CASE WHEN  (coal(T4.LAST_24MON_OVD_FLAG_10,''0'') + 0) > ''0'' OR  (coal(T14.LAST_24MON_OVD_FLAG_10,''0'') + 0) > ''0'' ';
v_sql32 := v_sql32||'         THEN ''1'' ';
v_sql32 := v_sql32||'         ELSE ''0'' ';
v_sql32 := v_sql32||'    END , ';
v_sql32 := v_sql32||'    CASE WHEN  (coal(T4.LAST_24MON_OVD_FLAG_11,''0'') + 0) > ''0'' OR  (coal(T14.LAST_24MON_OVD_FLAG_11,''0'') + 0) > ''0'' ';
v_sql32 := v_sql32||'         THEN ''1'' ';
v_sql32 := v_sql32||'         ELSE ''0'' ';
v_sql32 := v_sql32||'    END , ';
v_sql32 := v_sql32||'    CASE WHEN  (coal(T4.LAST_24MON_OVD_FLAG_12,''0'') + 0) > ''0'' OR  (coal(T14.LAST_24MON_OVD_FLAG_12,''0'') + 0) > ''0'' ';
v_sql32 := v_sql32||'         THEN ''1'' ';
v_sql32 := v_sql32||'         ELSE ''0'' ';
v_sql32 := v_sql32||'    END , ';
