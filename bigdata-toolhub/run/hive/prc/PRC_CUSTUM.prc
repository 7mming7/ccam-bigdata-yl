...
v_sql := v_sql||'                                   datediff(  S.END_DATE ';
v_sql := v_sql||'                                   , CASE ';
v_sql := v_sql||'                                        WHEN todate(S.START_DATE,''yyyy-mm-dd'') < ';
...
v_sql := v_sql||'       datediff(toDate('' ' || YWDATE || ' '',''yyyy-mm-dd''), ';
...
v_sql := v_sql||'                                                                      ''yyyymmdd'') ';
v_sql := v_sql||'                                              THEN ';
v_sql := v_sql||'                                                         datediff(toDate(S.TLMT_END, ';
v_sql := v_sql||'                                                                  ''yyyymmdd'') ';
v_sql := v_sql||'                                                 , ';
v_sql := v_sql||'                                                         CASE ';
v_sql := v_sql||'                                                                 WHEN (S.START_DATE + 0) <= ';
...
v_sql := v_sql||'                     +   COAL (T2.MP_AUTHS, 0) ';
v_sql := v_sql||'                       * COAL (B.RATE_VAL0, 0) ';
v_sql := v_sql||'                       * (  datediff(T2.END_DATE ';
v_sql := v_sql||'                          , CASE ';
v_sql := v_sql||'                               WHEN todate(t.START_DATE,''yyyy-mm-dd'') < ';
v_sql := v_sql||'                                       ADD_MONTHS (toDate('' ' || YWDATE || ' '',''yyyy-mm-dd''), -1) ';
v_sql := v_sql||'                               THEN ';
...
v_sql := v_sql||'                                   S.CRED_LIMIT CRED_LIMIT, ';
v_sql := v_sql||'                                   A.MP_L_LMT MP_L_LMT, ';
v_sql := v_sql||'                                  datediff (   todate(S.END_DATE,''yyyy-mm-dd'') ';
v_sql := v_sql||'                                   , CASE ';
v_sql := v_sql||'                                        WHEN todate(S.START_DATE,''yyyy-mm-dd'') < ';
v_sql := v_sql||'                                                ADD_MONTHS (toDate('' ' || YWDATE || ' '',''yyyy-mm-dd''), ';
v_sql := v_sql||'                                                            -1) ';
...
v_sql32 := v_sql32||'                   datediff(SYSDATE(),todate(T3.YYYYMMDD_BIRTH,''yyyy-mm-dd'')) ';
v_sql32 := v_sql32||'                 / 365) ';
v_sql32 := v_sql32||'        END, ';
...
v_sql32 := v_sql32||'         ELSE ';
v_sql32 := v_sql32||'          CEIL( datediff(SYSDATE(),todate(T1.LAST_CUS_TEMP_LINE_ADJ,''yyyy-mm-dd'')) ) ';
v_sql32 := v_sql32||'      END, ';
...
v_sql32 := v_sql32||'                WHERE LINS_DATE_ST <> 0) ta ';
...
v_sql32 := v_sql32||'                WHERE LINS_DATE_ST <> 0) tb';
