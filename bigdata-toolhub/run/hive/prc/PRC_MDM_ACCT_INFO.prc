...
BEGIN
    ...
    v_sql6 := v_sql6||'                                                                         , ';
    v_sql6 := v_sql6||'            CASE ';
    v_sql6 := v_sql6||'               WHEN (T0.CLOSE_CODE + 0) is null THEN ''0'' ';
    v_sql6 := v_sql6||'               ELSE ''1'' ';
    v_sql6 := v_sql6||'            END ';
    v_sql6 := v_sql6||'               AS PRO_ACCTSTATUS_CC_EXISTING                        ';
    v_sql6 := v_sql6||'                                            , ';
    v_sql6 := v_sql6||'            CASE ';
    v_sql6 := v_sql6||'               WHEN T0.BAL > 300 AND (T0.CLOSE_CODE + 0) is not null ';
    v_sql6 := v_sql6||'               THEN ';
    v_sql6 := v_sql6||'                  ''1'' ';
    v_sql6 := v_sql6||'               ELSE ';
    v_sql6 := v_sql6||'                  ''0'' ';
    ...
    v_sql7 := v_sql7||'                                                                         , ';
    v_sql7 := v_sql7||'            CASE ';
    v_sql7 := v_sql7||'               WHEN (T0.CLOSE_CODE + 0) is null THEN ''0'' ';
    v_sql7 := v_sql7||'               ELSE ''1'' ';
    v_sql7 := v_sql7||'            END ';
    v_sql7 := v_sql7||'               AS PRO_ACCTSTATUS_CC_EXISTING                        ';
    v_sql7 := v_sql7||'                                            , ';
    v_sql7 := v_sql7||'            CASE ';
    v_sql7 := v_sql7||'               WHEN T0.BAL > 300 AND (T0.CLOSE_CODE + 0) is not null ';
    v_sql7 := v_sql7||'               THEN ';
    v_sql7 := v_sql7||'                  ''1'' ';
    v_sql7 := v_sql7||'               ELSE ';
    v_sql7 := v_sql7||'                  ''0'' ';
